...
def main(args):
    image_dir = args.input_dir+'/Resized_Images/scene_img_abstract_v002_%s/'
    annotation_file = args.input_dir+'/Annotations/abstract_v002_%s_annotations.json'
    question_file = args.input_dir+'/Questions/MultipleChoice_abstract_v002_%s_questions.json'
