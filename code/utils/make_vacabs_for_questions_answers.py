...
def main(args):
    ...
    make_vocab_answers(answer_dir, n_answers)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='../datasets/Questions/Questions_Train_abstract_v002',
                        help='directory for input questions and answers')
    parser.add_argument('--answer_dir', type=str, default='../datasets/Annotations/Annotations_Train_abstract_v002',
                        help='directory for input questions and answers')
